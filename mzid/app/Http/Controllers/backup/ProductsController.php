...
class ProductsController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('backEnd.products.create', compact('menu_active', 'Category'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('backEnd.products.edit', compact('edit_product', 'menu_active', 'Category', 'edit_category'));
    }
