...
<body style="background:#FFF;">
                        ...
                        <div class="card-body card-dashboard">
                            <table class="table table-striped table-bordered responsive">
                                ...
                                <tbody>
                                    ...
                                    <tr style="text-align: center; vertical-align: middle;">
                                        <td>{{$i++}}</td>
                                        <td><img src="{{public_path('/storage/'.$user->image)}}" width="100px;"></td>
                                        <td>{{$user->name}}</td>
    ...
    <script src="{{public_path('/adminstyle/app-assets/vendors/js/tables/datatable/dataTables.responsive.min.js')}}"></script>
    <script src="{{public_path('/adminstyle/app-assets/vendors/js/tables/buttons.colVis.min.js')}}"></script>
    <script src="{{public_path('/adminstyle/app-assets/vendors/js/tables/datatable/dataTables.colReorder.min.js')}}"></script>
    <script src="{{public_path('/adminstyle/app-assets/vendors/js/tables/datatable/dataTables.buttons.min.js')}}"></script>
    <script src="{{public_path('/adminstyle/app-assets/vendors/js/tables/datatable/buttons.bootstrap4.min.js')}}"></script>
    <script src="{{public_path('/adminstyle/app-assets/vendors/js/tables/datatable/dataTables.fixedHeader.min.js')}}"></script>
    <!-- END: Page Vendor JS-->

    <!-- BEGIN: Theme JS-->
    <script src="{{public_path('/adminstyle/app-assets/js/core/app-menu.min.js')}}"></script>
    <script src="{{public_path('/adminstyle/app-assets/js/core/app.min.js')}}"></script>
    <script src="{{public_path('/adminstyle/app-assets/js/scripts/customizer.min.js')}}"></script>
    <!-- END: Theme JS-->
